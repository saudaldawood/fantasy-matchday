...
exports.awardWeeklyRewards = exports.purchasePowerUp = exports.awardMatchParticipationCredits = exports.awardDailyLoginCredits = void 0;
 ...
 */
exports.awardDailyLoginCredits = functions.https.onCall(async (data, context) => {
    var _a;
    if (!context.auth) {
    ...
    try {
        ...
        const lastLoginReward = (_a = userData.lastLoginReward) === null || _a === void 0 ? void 0 : _a.toDate();
 ...
 */
exports.awardMatchParticipationCredits = functions.firestore
 ...
 */
exports.purchasePowerUp = functions.https.onCall(async (data, context) => {
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
    }
 ...
 */
exports.awardWeeklyRewards = functions.pubsub
