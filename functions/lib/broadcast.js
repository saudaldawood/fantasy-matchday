...
exports.getBroadcastHistory = exports.processScheduledBroadcasts = exports.sendBroadcastNotification = void 0;
 ...
 */
exports.getBroadcastHistory = functions.https.onCall(async (data, context) => {
    var _a;
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be logged in');
    }
    ...
    const historyQuery = await db.collection('broadcastHistory')
        ...
        .limit(data.limit || 50)
        .get();
    const history = historyQuery.docs.map(doc => (Object.assign({ id: doc.id }, doc.data())));
    return { history };
});
